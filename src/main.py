...
|  encima de la misma son nulos. Para determinar el peor de los  |
|  casos, asumimos que todos los elementos restantes en la       |
|  matriz son no nulos y distintos de uno.                       |
...
|       elementos nulos, y sabiendo que el número de elementos   |
...
|________________________________________________________________|
|                                                                |
|  De la matriz U, se sabe que todos los elementos debajo de la  |
